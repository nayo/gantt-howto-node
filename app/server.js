...
db.query('CREATE TABLE IF NOT EXISTS `gantt_links` ( \
  `id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,\
  `source` int(11) NOT NULL,\
  `target` int(11) NOT NULL,\
  `type` varchar(1) COLLATE utf8_unicode_ci NOT NULL\
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;', function (err, result, fields) {
    if (err) throw new Error(err)
})

db.query('CREATE TABLE IF NOT EXISTS `gantt_tasks` ( \
  `id` int(11) NOT NULL  AUTO_INCREMENT PRIMARY KEY, \
